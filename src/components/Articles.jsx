...
import TestimonialsQueue from "./build/TestimonialsStack";
import { ArticleBubble } from "./build/ArticleBubble";
function Articles() {
    const articleData = [
        {
          ...
          return (
            ...
            >
              <ArticleBubble
                key={index}
                image={
                  "https://png.pngtree.com/png-vector/20230307/ourmid/pngtree-article-vector-icon-design-illustration-png-image_6637011.png"
                }
                alt={item.alt}
                title={item.title}
